...
async function renderHomeWeather() {
  ...
  if (cityEl) cityEl.textContent = rawCity; // 批次 233：按钮显示完整「城市·区县」，天气仍按聚合地级市查询
...
// 批次 221/233：城市→区县全量映射（直辖市/热门城市为手工精校最新区划；其余 241 城取自民政部行政区划数据集(province-city-china, 2021 版)补全）。
// 反查表 RT_DISTRICT_TO_CITY 由本表自动构建（见下方 IIFE）。
  ...
  '成都': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '新津区', '高新区', '天府新区', '东部新区', '简阳市', '都江堰市', '彭州市', '邛崃市', '崇州市', '金堂县', '大邑县', '蒲江县'],
  ...
  '秦皇岛': ['海港区', '山海关区', '北戴河区', '抚宁区', '青龙满族自治县', '昌黎县', '卢龙县', '北戴河新区'],
  '邯郸': ['邯山区', '丛台区', '复兴区', '峰峰矿区', '肥乡区', '永年区', '临漳县', '成安县', '大名县', '涉县', '磁县', '邱县', '鸡泽县', '广平县', '馆陶县', '魏县', '曲周县', '武安市', '邯郸冀南新区'],
  '保定': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '定州市', '安国市', '高碑店市', '保定白沟新城'],
  ...
  '沧州': ['新华区', '运河区', '沧县', '青县', '东光县', '海兴县', '盐山县', '肃宁县', '南皮县', '吴桥县', '献县', '孟村回族自治县', '泊头市', '任丘市', '黄骅市', '河间市', '沧州渤海新区'],
  '廊坊': ['安次区', '广阳区', '固安县', '永清县', '香河县', '大城县', '文安县', '大厂回族自治县', '霸州市', '三河市'],
  '大同': ['新荣区', '平城区', '云冈区', '云州区', '阳高县', '天镇县', '广灵县', '灵丘县', '浑源县', '左云县'],
  '阳泉': ['城区', '矿区', '郊区', '平定县', '盂县'],
  '长治': ['潞州区', '上党区', '屯留区', '潞城区', '襄垣县', '平顺县', '黎城县', '壶关县', '长子县', '武乡县', '沁县', '沁源县', '山西长治高新技术产业园区'],
  ...
  '吉林': ['昌邑区', '龙潭区', '船营区', '丰满区', '永吉县', '蛟河市', '桦甸市', '舒兰市', '磐石市', '吉林中国新加坡食品区'],
  ...
  '镇江': ['京口区', '润州区', '丹徒区', '丹阳市', '扬中市', '句容市', '镇江新区'],
  ...
  '阜阳': ['颍州区', '颍东区', '颍泉区', '临泉县', '太和县', '阜南县', '颍上县', '界首市', '阜阳合肥现代产业园区'],
  '宿州': ['埇桥区', '砀山县', '萧县', '灵璧县', '泗县', '宿州马鞍山现代产业园区'],
  '莆田': ['城厢区', '涵江区', '荔城区', '秀屿区', '仙游县'],
  '三明': ['梅列区', '三元区', '明溪县', '清流县', '宁化县', '大田县', '尤溪县', '沙县', '将乐县', '泰宁县', '建宁县', '永安市', '三元区', '沙县区'],
  '泉州': ['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '金门县', '石狮市', '晋江市', '南安市'],
  '漳州': ['芗城区', '龙文区', '云霄县', '漳浦县', '诏安县', '长泰县', '东山县', '南靖县', '平和县', '华安县', '龙海市', '龙海区', '长泰区'],
  ...
  '洛阳': ['老城区', '西工区', '瀍河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市', '偃师区', '孟津区'],
  '平顶山': ['新华区', '卫东区', '石龙区', '湛河区', '宝丰县', '叶县', '鲁山县', '郏县', '舞钢市', '汝州市', '平顶山市城乡一体化示范区'],
  '安阳': ['文峰区', '北关区', '殷都区', '龙安区', '安阳县', '汤阴县', '滑县', '内黄县', '林州市'],
  '新乡': ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '卫辉市', '辉县市', '长垣市', '新乡市平原城乡一体化示范区'],
  '焦作': ['解放区', '中站区', '马村区', '山阳区', '修武县', '博爱县', '武陟县', '温县', '沁阳市', '孟州市', '焦作城乡一体化示范区'],
  '许昌': ['魏都区', '建安区', '鄢陵县', '襄城县', '禹州市', '长葛市'],
  '漯河': ['源汇区', '郾城区', '召陵区', '舞阳县', '临颍县'],
  '南阳': ['宛城区', '卧龙区', '南召县', '方城县', '西峡县', '镇平县', '内乡县', '淅川县', '社旗县', '唐河县', '新野县', '桐柏县', '邓州市', '南阳市城乡一体化示范区'],
  '商丘': ['梁园区', '睢阳区', '民权县', '睢县', '宁陵县', '柘城县', '虞城县', '夏邑县', '永城市', '豫东综合物流产业聚集区'],
  ...
  '随州': ['曾都区', '随县', '广水市'],
  '株洲': ['荷塘区', '芦淞区', '石峰区', '天元区', '渌口区', '攸县', '茶陵县', '炎陵县', '醴陵市', '云龙示范区'],
  '湘潭': ['雨湖区', '岳塘区', '湘潭县', '湘乡市', '韶山市', '湖南湘潭高新技术产业园区', '湘潭昭山示范区', '湘潭九华示范区'],
  '衡阳': ['珠晖区', '雁峰区', '石鼓区', '蒸湘区', '南岳区', '衡阳县', '衡南县', '衡山县', '衡东县', '祁东县', '耒阳市', '常宁市', '衡阳综合保税区', '湖南衡阳高新技术产业园区'],
  ...
  '益阳': ['资阳区', '赫山区', '南县', '桃江县', '安化县', '沅江市', '湖南益阳高新技术产业园区'],
  '郴州': ['北湖区', '苏仙区', '桂阳县', '宜章县', '永兴县', '嘉禾县', '临武县', '汝城县', '桂东县', '安仁县', '资兴市'],
  '永州': ['零陵区', '冷水滩区', '祁阳县', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县', '祁阳市'],
  ...
  '毕节': ['七星关区', '大方县', '黔西县', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县', '黔西市'],
  ...
  '楚雄': ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县', '禄丰市'],
  ...
  '铜川': ['王益区', '印台区', '耀州区', '宜君县'],
  '宝鸡': ['渭滨区', '金台区', '陈仓区', '凤翔县', '岐山县', '扶风县', '眉县', '陇县', '千阳县', '麟游县', '凤县', '太白县', '凤翔区'],
  ...
  '安康': ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳县', '白河县', '旬阳市'],
  ...
  '拉萨': ['城关区', '堆龙德庆区', '达孜区', '林周县', '当雄县', '尼木县', '曲水县', '墨竹工卡县', '格尔木藏青工业园区', '西藏文化旅游创意园区', '达孜工业园区'],
  ...
  '塔城': ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔蒙古自治县', '沙湾市'],
