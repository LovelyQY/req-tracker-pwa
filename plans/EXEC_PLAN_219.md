...
| 226 | v1.4.32 | 日历与考勤（上）：清理/周末假期/打卡分上下午 | 4 |
| 227 | v1.4.33 | 日历与考勤（下）：颜色统一/事件类型/云端时间 | 5 |
| 228 | v1.4.34 | 设置清理与个人信息 | 4 |
| 229 | v1.4.35 | 设置展示与反馈 | 5 |
| 230 | v1.4.36 | 导出（本地/邮箱/腾讯文档）与初始化示例入口 | 5 |
| 231 | v1.4.37 | 表单模板增强 | 5 |
| 232 | v1.4.38 | 工作流增强：职位审批 + 直接生成工作流 | 2 |
| 233 | v1.4.39 | 日历与流程关联 | 2 |
...
## 六、Batch 221（v1.4.26 / 后续修正 v1.4.31）— 首页头部：应用名 / 通知 / 城市 ✅ 已完成并部署
...
## 十一、Batch 226（v1.4.32）— 日历与考勤（上）：清理 / 周末假期 / 打卡分上下午
...
## 十二、Batch 227（v1.4.33）— 日历与考勤（下）：颜色统一 / 事件类型 / 云端时间
...
## 十三、Batch 228（v1.4.34）— 设置清理与个人信息
...
## 十五、Batch 230（v1.4.36）— 导出（本地/邮箱/腾讯文档）与初始化示例入口
...
## 十七、Batch 232（v1.4.38）— 工作流增强：职位审批 + 直接生成工作流
